"""Restore the breast-cancer classifier and prepare its test data."""
...
test_csv = asset_path(
    "test_data.csv",
    "section_3/labs/030-150-evaluate-our-models/test_data.csv",
)
...
test_dataset = BreastCancerDataset(test_csv, image_root, test_transform)
