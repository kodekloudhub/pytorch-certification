...
# Download the lab prerequisite and questions
LAB_BASE_URL=https://raw.githubusercontent.com/kodekloudhub/pytorch-certification/main/section_4/labs/040-090-inference-best-practices
wget -O pre.py "$LAB_BASE_URL/pre.py"
for question_number in {1..4}; do
    wget -O "question_$question_number.py" \
        "$LAB_BASE_URL/question_$question_number.py"
done

# Download the Section 3 test annotations and trained MobileNetV3 checkpoint
SECTION_3_LAB_URL=https://raw.githubusercontent.com/kodekloudhub/pytorch-certification/main/section_3/labs/030-150-evaluate-our-models
wget -O test_data.csv "$SECTION_3_LAB_URL/test_data.csv"
wget -O mobilenet_checkpoint.tar "$SECTION_3_LAB_URL/mobilenet_checkpoint.tar"
