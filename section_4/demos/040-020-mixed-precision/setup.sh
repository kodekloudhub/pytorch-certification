...
DEMO_BASE_URL=https://raw.githubusercontent.com/kodekloudhub/pytorch-certification/main/section_4/demos/040-020-mixed-precision
wget -O mixed-precision.ipynb "$DEMO_BASE_URL/mixed-precision.ipynb"
wget -O mixed_precision.py "$DEMO_BASE_URL/mixed_precision.py"
