...
DEMO_BASE_URL=https://raw.githubusercontent.com/kodekloudhub/pytorch-certification/main/section_4/demos/040-080-inference-best-practices
wget -O inference-best-practices.ipynb "$DEMO_BASE_URL/inference-best-practices.ipynb"
wget -O inference_best_practices.py "$DEMO_BASE_URL/inference_best_practices.py"
