...
wget -O setting-up-pytorch.ipynb https://raw.githubusercontent.com/kodekloudhub/pytorch-certification/main/section_1/demos/010-035-setting-up-pytorch/setting-up-pytorch.ipynb
