...
DEMO_BASE_URL=https://raw.githubusercontent.com/kodekloudhub/pytorch-certification/main/section_2/demos/020-045-introduction-to-transformation
wget -O introduction-to-transformations.ipynb "$DEMO_BASE_URL/introduction-to-transformations.ipynb"
